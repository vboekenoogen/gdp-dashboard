...
def tokenize_sentences(text):
    """Split text into individual sentences with specific rules"""
    if not text:
        return []
    
    # First, extract hashtags and process them separately
...
def main():
    ...
    with st.sidebar:
        ...
        **Processing Rules:**
        - Each statement contains one sentence
        - Hashtags retained as separate sentences
        - Punctuation-only statements removed
        """)
        ...
        **Statement Rules:**
        ...
        - Hashtags as separate sentences
        - No punctuation-only statements
        """)
    ...
    if uploaded_file is not None:
        ...
        with col1:
            ...
            example_input = pd.DataFrame({
                ...
                'caption': [
                    ...
                    'Allow me to introduce myself. I make custom clothing! #fashion #custom #pittsburgh'
                ]
            })
        ...
        with col2:
            ...
            example_output = pd.DataFrame({
                'ID': ['Cc8dyfCLwTX', 'CTFccmHFfZQ', 'CTFccmHFfZQ', 'CTFccmHFfZQ'],
                'Sentence ID': [1, 1, 2, 3],
                'Context': [
                    'No other way to walk into warmer weather✨',
                    'Allow me to introduce myself. I make custom clothing! #fashion #custom #pittsburgh',
                ...
                'Statement': [
                    ...
                    'I make custom clothing!',
                    '#fashion #custom #pittsburgh'
                ]
            })
...
if __name__ == "__main__":
    ...
    # Filter out statements containing only punctuation
    clean_sentences = []
    for sentence in all_sentences:
        # Remove punctuation and whitespace to check if any alphanumeric content remains
        alphanumeric_content = re.sub(r'[^\w#]', '', sentence)
        if alphanumeric_content:  # Keep if it has alphanumeric characters or hashtags
